...
| Partial write | Packetized RTL smoke + abstract model + reference-path strobes | Coverage-guided partial-write bias |
| Transfer size | Naturally aligned byte/halfword/full-width reference + UVM traffic | Unaligned transfers and boundary-focused cases |
