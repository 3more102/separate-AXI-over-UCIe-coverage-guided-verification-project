...
- UVM methodology layer with AXI driver/sequencer, source/destination monitors, end-to-end semantic scoreboard, covergroups, legal narrow-transfer stimulus, and a coverage-guided sequence.
