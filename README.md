...
- UVM methodology layer with AXI driver/sequencer, source/destination monitors, end-to-end transport scoreboard, byte-accurate memory semantics checker, covergroups, and coverage-guided plus directed sequences.
