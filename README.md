...
- UVM methodology layer with AXI driver/sequencer, source/destination monitors, end-to-end semantic scoreboard, covergroups, legal byte/halfword/full-width transfer sizing, and a coverage-guided sequence.
