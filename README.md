...
- UVM methodology layer with AXI driver/sequencer, source/destination monitors, end-to-end semantic scoreboard, byte/halfword/full-width transfer coverage, partial-strobe coverage, and a coverage-guided sequence.
