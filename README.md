...
- UVM methodology layer with AXI driver/sequencer, source/destination monitors, end-to-end semantic scoreboard, partial-strobe coverage, legal byte/halfword/full-width transfer sizing, and a coverage-guided sequence.
- Python unit tests, Icarus packet smoke/lint, Verilator burst/narrow-transfer reference smoke, and GitHub Actions CI.
